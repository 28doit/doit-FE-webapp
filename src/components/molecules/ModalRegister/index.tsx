...
export const ModalRegisterItem =
  ({}: RegisterItemProps): React.ReactElement => {
    ...
    const changeAccountEvent = (e: any) => {
      setAccount({
        ...Account,
                  ...
                  <S.PC_Wrap wrap_type="select">
                    ...
                    <S.PC_Box box="pre">
                      <S.PC_Pre>
                        ...
                        경우 "몰“은 개정 전 내용과 개정 후 내용을 명확하게
                        비교하여 이용자가 알기 쉽도록 표시합니다. <br></br>
                        <br></br>⑤ “몰”이 약관을 개정할 경우에는 그 개정약관은
                        그 적용일자 이후에 체결되는 계약에만 적용되고 그 이전에
                        ...
                        정하는 「전자상거래 등에서의 소비자 보호지침」 및
                        관계법령 또는 상관례에 따릅니다.
                        <br></br>
                        <br></br>제4조(서비스의 제공 및 변경) <br></br>
                        <br></br>① “몰”은 다음과 같은 업무를 수행합니다.{' '}
                        <br></br>
                        <br></br>1. 재화 또는 용역에 대한 정보 제공 및
                        구매계약의 체결 2. 구매계약이 체결된 재화 또는 용역의
                        배송 3. 기타 “몰”이 정하는 업무 <br></br>
                        <br></br>② “몰”은 재화 또는 용역의 품절 또는 기술적
                        사양의 변경 등의 경우에는 장차 체결되는 계약에 의해
                        제공할 재화 또는 용역의 내용을 변경할 수 있습니다. 이
                        경우에는 변경된 재화 또는 용역의 내용 및 제공일자를
